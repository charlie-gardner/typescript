...
class GateData {
    static and(wh) {
        ...
        ans.push([wh[0], 0]);
        ans.push([wh[0], h]);
        Tricks.arc(ans, [0, h], wh[0], 0, Math.PI);
        ans.push([-wh[0], h]);
        ans.push([-wh[0], 0]);
        return ans;
    }
    static nand(wh) {
        ...
        ans.push([wh[0], 0]);
        ans.push([wh[0], h]);
        Tricks.arc(ans, [0, h], wh[0], 0, Math.PI / 2);
        Tricks.arc(ans, [0, h + wh[0] + radius], radius, Math.PI * 3 / 2, Math.PI * 3 / 2);
        Tricks.arc(ans, [0, h], wh[0], Math.PI / 2, Math.PI);
        ans.push([-wh[0], h]);
        ans.push([-wh[0], 0]);
        return ans;
    }
    static nor(wh) {
        ...
        let ans = [];
        Tricks.arc(ans, [0, center], radius, a, (divide - 1) * a);
        ans.push([-x, 0]);
        ans.push([-x10, y10]);
        ans.push([-x11, y11]);
        ans.push([-x12, y12]);
        ...
        Tricks.arc(ans, [0, height - radius2], radius2, Math.PI * 3 / 2, Math.PI * 3 / 2);
        ans.push([0, height - fix * radius2]);
        ans.push([x13, y13]);
        ans.push([x12, y12]);
        ans.push([x11, y11]);
    ...
    static not(wh) {
        ...
        ans.push([-wh[0], 0]);
        ans.push([0, h]);
        Tricks.arc(ans, [0, h + radius], radius, Math.PI * 3 / 2, Math.PI * 3 / 2);
        ans.push([wh[0], 0]);
        return ans;
    }
    static or(wh) {
